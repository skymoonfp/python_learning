...
for i in range(n):
    if Bookie(n0, n1, n2, n3, n4, n5, p1, p2, p3, p4, p5) == 'a':
        win1 += 1
    elif Bookie(n0, n1, n2, n3, n4, n5, p1, p2, p3, p4, p5) == 'b':
        win2 += 1
    elif Bookie(n0, n1, n2, n3, n4, n5, p1, p2, p3, p4, p5) == 'c':
        win3 += 1
    elif Bookie(n0, n1, n2, n3, n4, n5, p1, p2, p3, p4, p5) == 'd':
        win4 += 1
    elif Bookie(n0, n1, n2, n3, n4, n5, p1, p2, p3, p4, p5) == 'e':
        win5 += 1
